...
export const getResetPasswordPending = (state: RootState) =>
  state.auth.resetPasswordPending;
export const getResetCodeSuccess = (state: RootState) =>
  state.auth.resetCodeSuccess;
...
export const getChangeUserDataSuccess = (state: RootState) =>
  state.auth.changeUserDataSuccess;
export const getChangeUserDataPending = (state: RootState) =>
  state.auth.changeUserDataPending;
